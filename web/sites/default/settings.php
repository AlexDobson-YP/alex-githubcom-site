 ...
 * @endcode
 */
$settings['hash_salt'] = getenv('HASH_SALT') ?: "FoXHxCsp_ZsyzrSTqr04xvHyf55FPsHbAv_-lrTnJpDeXUh1Zl4vt4UZJwAetCS224oZZzWx0s";
...
/**
 * Redis cache server optional configuration.
 */
if (!empty(getenv('REDIS_CACHE_PREFIX'))) {
  // Redis settings.
  $settings['redis.connection']['interface'] = 'PhpRedis';
  $settings['redis.connection']['host'] = getenv('REDIS_CONNECTION');
  $settings['cache_prefix'] = getenv('REDIS_CACHE_PREFIX');
